$(document).ready(function() {
    ...
    $("#ricerca").on("click", function() {
        ...
        if(cittapartenza == "none") {
            alert("Devi selezionare la città di partenza!");
            return false;
        }
        var cittaarrivo = document.getElementById("cittaArrivo").value;
        if(cittaarrivo == "none") {
            alert("Devi selezionare la città di arrivo!");
            return false;
        }
        ...
        var dataritorno = document.getElementById("dataRitorno").value;
        anno = dataritorno.substr(2, 2);
        mese = dataritorno.substr(5, 2);
        giorno = dataritorno.substr(8 ,2);
        dataritorno= anno+mese+giorno;
        alert("Andata: "+dataandata+", ritorno: "+dataritorno);
        var link = "https://www.skyscanner.it/trasporti/voli/"+cittapartenza+"/"+cittaarrivo+"/"+dataandata+"/"+dataritorno+"/?adults=1&children=0&adultsv2=1&childrenv2=&infants=0&cabinclass=economy&rtn=1&preferdirects=false&outboundaltsenabled=false&inboundaltsenabled=false&ref=home#results"
